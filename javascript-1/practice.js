...
let colorCopy = faveColors.slice(0, 1, 2);

//////////////////PROBLEM 9////////////////////

// Add a fourth color to the end of the 'colorCopy' array using push.

colorCopy.push(0, 1, 'blue');
...
var myNumbersIndex = [];
myNumbers.forEach(function(element, i) {
...
let forTheLoveOfGeorge = notGeorge.map((element,i,notGeorge) => {
	return 'George';
});
...
var enemies = people.filter((element,i,people) => {
...
let totallyAwesome = people.reduce(function(runningTotal, curElement, i, wholeArray) {
	let x = runningTotal + curElement.awesomeLevel;
	return x;
});
